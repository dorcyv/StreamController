...
class AutoChangeGroup(Adw.PreferencesGroup):
    ...
    def build(self):
        ...
        self.restore_on_leave = Adw.SwitchRow(title="Restore on leave", subtitle="Restore the last page when you leave an automatically loaded page")
        self.add(self.restore_on_leave)
    ...
    def connect_signals(self):
        ...
        self.restore_on_leave.connect("notify::active", self.on_filter_apply)
    ...
    def disconnect_signals(self):
        ...
        self.restore_on_leave.disconnect_by_func(self.on_filter_apply)
    ...
    def on_filter_apply(self, entry: Adw.EntryRow, *args):
        ...
        auto_change = {
            ...
            "restore_on_leave": self.restore_on_leave.get_active()
        }
    ...
    def load_config_settings(self):
        ...
        self.restore_on_leave.set_active(auto_change.get("restore_on_leave", False))
